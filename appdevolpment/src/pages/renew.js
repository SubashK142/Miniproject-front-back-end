...
      });
  ...
  return (
    ...
    <div className='policy' style={{width:'100vw',height:'704px'}}>
      ...
      <div style={{justifyContent:'left',display:'flex',flexDirection:'column',fontSize:40,alignItems:'flex-start',marginTop:50,marginLeft:200,wordSpacing:8}}>
      <p>Insurance ID :{id}</p>
      ...
      <button onClick={clear} style={{marginTop:10,marginLeft:50}}> Clear due</button>
      </div>
    </div>
    </>
  )
